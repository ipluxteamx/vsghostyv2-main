...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		levelInfo.setFormat(Paths.font("GALS.ttf"), 32);
		...
		levelDifficulty.setFormat(Paths.font('GALS.ttf'), 32);
		...
		blueballedTxt.setFormat(Paths.font('GALS.ttf'), 32);
		blueballedTxt.updateHitbox();
		add(blueballedTxt);

		practiceText = new FlxText(20, 15 + 101, 0, "PRACTICE MODE", 32);
		practiceText.scrollFactor.set();
		practiceText.setFormat(Paths.font('GALS.ttf'), 32);
		...
		botplayText.setFormat(Paths.font('GALS.ttf'), 32);
