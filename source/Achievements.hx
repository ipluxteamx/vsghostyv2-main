...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Hidden achievement
		...
		["Ghost The Fuck Out",	    	"Beat Week 1 on Crazy with less than 5 Misses.",		false],
		["Got That Tongue For Yo Girl",	"Beat Week 2 on Crazy with less than 5 Misses.",		false],
		["Call Me The Hitman",			"Beat Week 3 on Crazy with less than 5 Misses.",		 true],
		["Lady Killer",					"Beat Week 4 on Crazy with no Misses.",					 true],
		["Missless Christmas",			"Beat Week 5 on Crazy with no Misses.",					 true],
		["Highscore!!",					"Beat Week 6 on Crazy with no Misses.",					 true],
		["You'll Pay For That...",		"Beat Week 7 on Crazy with no Misses.",					 true],
		["What a Funkin' Disaster!",	"Complete a Song with a rating lower than 20%.",		false],
		["Perfectionist or Gegcoin",	"Complete a Song with a rating of 100%.",				false],
...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(id:Int, ?camera:FlxCamera = null)
	{
		...
		achievementName.setFormat(Paths.font("gameplay.ttf"), 16, FlxColor.WHITE, LEFT);
		achievementName.scrollFactor.set();

		var achievementText:FlxText = new FlxText(achievementName.x, achievementName.y + 32, 280, Achievements.achievementsStuff[id][1], 16);
		achievementText.setFormat(Paths.font("gameplay.ttf"), 16, FlxColor.WHITE, LEFT);
